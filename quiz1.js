...
var data = [{
    "type": "radio",
    "question": "Electricity is the flow of ____ from one place to another place.",
    "explanation": "The flow of electrons from one place to another place is called electricity.",
    "options": [{
        "value": "Water",
        "right": false,
        "selected": false
    ...
    "type": "radio",
    "question": "The SPEED of electrons as they move from one place to another is called ____.",
    "explanation": "The speed of electrons from one place to another place is called current.",
    "options": [{
        "value": "Current",
        "right": true,
        "selected": false
    ...
    "type": "radio",
    "question": "If electrons are moving very fast, then the current is ____.",
    "explanation": "Current is high when electrons are moving fast and low when electrons are moving slow.",
    "options": [{
        "value": "Zero",
        "right": false,
        "selected": false
    ...
    "type": "radio",
    "question": "The starting place of electricity is ____.",
    "explanation": "Electricity travels through a system of metal wires from the power plant to your house and other buildings.",
    "options": [{
        "value": "Your House",
        "right": false,
        "selected": false
    ...
    "type": "radio",
    "question": "Which of the following use electricity?",
    "explanation": "Smartphones require electricity to power them for usage. Bicycles and staplers use human force, and candles use fire.",
    "options": [{
        "value": "Bicycle",
        "right": false,
        "selected": false
